  ...
  return {
    find: function find(selector) {
      ...
      for (var i = 0; i < elements.length; i++) {
        var tmp = Array.from(elements[i].querySelectorAll(selector));
        array = array.concat(tmp);
      }

      array.oldApi = this; //重新返回一个新的对象用于后续调用

      return jQuery(array); // elements = array return this 会改变所有elements的值
    },
